...
public class Animal {
    ...
    */
    ...
    /*
    c) Ama coklu parent'lardan yararlanamamak iyi olmadi. Ozelliklerini inherit etmek istedigimiz class'lar birden
    fazla ise (parent'lar) o durumda Java bize, Apartman tarzi yapilanma olusturmustur. ( 'Multi Level Inheritance')
    Java bunu kabul eder.
    */
    ...
    */
    ...
    // Soru2: static method’lar override edilebilir mi? // Mesela ay'ı kimse hareket ettiremez. Bundan herkes etkilenir.
