...
public class DateTime01 {
    public static void main(String[] args) {
        ...
        System.out.println(myDate.minusYears(1).minusMonths(0).minusDays(2)); // 2023-09-30
        ...
        LocalDate date01 = LocalDate.of(1984, 5, 7);
        LocalDate date02 = LocalDate.of(2018, 5, 4);

        System.out.println("date = " + date01 + ", date02 = " + date02);
        ...
        boolean t1 = date01.isAfter(date02);
        System.out.println(t1); // false

        boolean t2 = date01.isBefore(date02);
