...
public class Scanner03 {
    public static void main(String[] args) {
        ...
        Scanner input = new Scanner(System.in).useLocale(Locale.US); // useLocale(Locale.US) yapmamızın sebebi girdi kısmında nokta kullanabilir duruma getirdik (Ornegin 10.5)
        ...
        System.out.println("Subtraction : " + String.format("%.2f", (firstNumber - secondNumber))); // double ve float için f koyabiliriz
