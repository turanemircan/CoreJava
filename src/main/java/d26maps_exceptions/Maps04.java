...
public class Maps04 {
    public static void main(String[] args) {
        ...
        */
        ...
        1- HashMap
            ...
            b) Multi Thread:
                ...
                Çok iş parçacıklı ortamlar için harici senkronizasyon gerektirir (Fazladan kod yazmak gerekir).
            c) Synchronized:
        ...
        */
        ...
        /*
        HashMap, Hashtable ve ConcurrentHashMap ne zaman kullanilir?
        ...
        */
        ...
        countryPopulation.put("Turkiye", 85000000);
        countryPopulation.put("Netherland", 18000000);
        // countryPopulation.put(null, 18000000); // HATA notural sıralama dan dolayı todo: Tekrar İzle
        countryPopulation.put("Italya", null);
        countryPopulation.put("France", null);

        System.out.println(countryPopulation); // {France=null, Germany=83000000, Italya=null, Netherland=18000000, Turkiye=85000000, USA=400000000}
        ...
        */
        ...
        for (Map.Entry<String, Integer> entry : lhm.entrySet()) {
            ...
            capitals.get("USA");
            capitals.put("İtaly", "Roma");
            capitals.put("Turkiye", "Ankara");
            capitals.get("Turkiye");
            capitals.put("Turkiye", "Istanbul"); // Todo: Tekrar İzle
        }
    }
}
