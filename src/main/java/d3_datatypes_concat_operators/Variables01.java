...
public class Variables01 {
    public static void main(String[] args) {
        ...
        // Java büyük sayıları default olarak integer kabul eder.
        ...
        long num01 = 15, num02 = 20;
        System.out.println("Sum = " + (num01 + num02)); // 35
        ...
        float sockPrice01 = 12.99f;
        float shirtPrice01 = 25.99f;
        System.out.println("Total Price01 = " + (sockPrice01 + shirtPrice01)); // Total Price01: 38.98

        // 2.yol:

        float sockPrice02 = 12.99f, shirtPrice02 = 25.99f;
        System.out.println("Total Price02 = " + (sockPrice02 + shirtPrice02)); // Total Price02: 38.98

        // 3 corap, 2 gomlek olsaydi?
        // What if there were 3 socks and 2 shirts?

        System.out.println("Total Price03 = " + (3 * sockPrice02 + 2 * shirtPrice02)); // Total Price03 = 90.95
        ...
        System.out.println(firstLetterOfTheName); // E
