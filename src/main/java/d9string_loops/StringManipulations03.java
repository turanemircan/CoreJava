...
public class StringManipulations03 {
    public static void main(String[] args) {
        ...
        */
        ...
        // 2- Karakterler sadece (space) boşluk karakterlerden ibaret olmalı, space harici karakterlerde bulunmalidir.
        ...
        boolean third = pwd.trim().equals(pwd); // trim baştaki ve sondaki boşlukları siler.
        System.out.println(third);

        if (first) {
            System.out.println("Parola hicbir şey yazmadan gecilemez");
        }
        if (second) {
