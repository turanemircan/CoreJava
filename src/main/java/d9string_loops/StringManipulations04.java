...
public class StringManipulations04 {
    public static void main(String[] args) {
        ...
        */
        ...
        // String str01 = "merhaba";
        // String str04 = "merhaba";

        String str01 = new String("Merhaba");
        String str02 = new String("Merhaba");
        String str03 = str01;

        System.out.println(str01 == str02); // false, adrese bakti
        System.out.println(str01.equals(str02)); // true, icerige bakti
        System.out.println(str01 == str03); // true, ayni adreste oturan kardesler
    }
}
