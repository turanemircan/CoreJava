...
public interface Engine {
    ...
    */
    ...
    object olusturarak ulasilabilir (Burdaki default access modifier degil)
    */
    ...
    */
    ...
    default void power() { // Burdaki defult keyword. Access modifier degil.
        System.out.println("200HP");
    }

    static void speed() { // Static override edilemez
