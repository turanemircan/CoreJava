...
public class Variables01 {
    public static void main(String[] args) {
        ...
        // Yorum Satiri olusturmak icin // veya /**/ isaretlerini kullanabiliriz.
        ...
        */
        ...
        // data type ==> veriable name ==> assigment operator ==> data ==> noktali virgul
        ...
        */
        ...
        System.out.println(countryPopulation); // 84000000
        System.out.println("countryPopulation = " + countryPopulation); // countryPopulation = 84000000
        ...
        int num01 = 11, num02 = 29, sum = num01 + num02;

        System.out.println("Toplam = " + (num01 + num02));
