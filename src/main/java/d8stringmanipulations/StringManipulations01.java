...
public class StringManipulations01 {
    public static void main(String[] args) {
        ...
        String s = "Learn *money* Java earn money";

        String s1 = s.replace("money", "dollar"); // birden fazla money varsa hepsini değiştirir.
        System.out.println(s1); // Learn *dollar* Java earn dollar

        // Ornek 2: "s" String'indeki tum "e" harflerini siliniz.
        // Example 2: Delete all "e" letters in the string "s".

        String s2 = s.replace("e", ""); // "" hiçlik anlamına gelir.
