...
public class Lambda05 {
    public static void main(String[] args) {
        ...
        // removeIfElementsStartsWithZorEndsWithf01(myList);
        // removeIfElementsStartsWithZorEndsWithf02(myList);
    ...
    public static void removeIfElementsStartsWithZorEndsWithf01(List<String> myList) {
    ...
    public static void removeIfElementsStartsWithZorEndsWithf02(List<String> myList) {
