...
public class Car {
    ...
    */
    ...
    /*
    6-Constructor nedir?
    Class'tan object olusturmamizi saglayan bolumdur. Bu yüzden static olamaz.
    ...
    */
    ...
    Java'da iki tür constructor vardir
    ...
    */
    ...
    public Car(String brand, String model, int year, boolean hybrid) {
        this.brand = brand; // Bu class'taki brand degrini kullanma, ben sana parametre olarak gonderecegim demektir.
        this.model = model;
        this.year = year;
        this.hybrid = hybrid;
    }
